//
//  AccountReportErrorViewController.swift
//  crm-finixlab
//
...
class AccountReportErrorViewController: BaseScrollingViewController {
    ...
    static func create() -> UIViewController {
        let vc = StoryboardManager.loadViewController(storyboard: "Account", viewControllerId: "AccountReportErrorViewController") as! AccountReportErrorViewController
    ...
    @IBAction func sendPressed(_ sender: Any) {
        ...
        let newFeedback = Feedback(partition: UserManager.shared.publicPartitionKey, type: "reportError", message: message, creatorEmail: UserManager.shared.email ?? "", creator: app.currentUser!.id)
        do {
...
extension AccountReportErrorViewController: UITextViewDelegate {
